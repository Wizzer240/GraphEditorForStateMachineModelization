...
public class ObjAttribute implements Cloneable {
  ...
  public ObjAttribute(String name2, String nameStatus, String value2,
      ...
      String typeStatus, String comm, String commStatus, Color color,
      String colorStatus, String useratts2, String userattsStatus,
  ...
  public boolean setSelectStatus(int x, int y) {
    if (myPage == currPage && getVisible())
    {
      ...
      /*
       * if(x >= tX+x2Obj-tW/2-4 && x <= tX+x2Obj-tW/2+tW+3 && y >=
       * tY+y2Obj-tH+2 && y <= tY+y2Obj+4)
       * selectStatus = 1;
       */
