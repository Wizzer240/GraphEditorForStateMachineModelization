...
public class FileParser6lines {
  ...
  private void resetGlobalList() {
    ...
    LinkedList<ObjAttribute> globalMachineAttributes = new LinkedList<ObjAttribute>();
    LinkedList<ObjAttribute> globalStateAttributes = new LinkedList<ObjAttribute>();
    LinkedList<ObjAttribute> globalTransAttributes = new LinkedList<ObjAttribute>();
    LinkedList<ObjAttribute> globalInputsAttributes = new LinkedList<ObjAttribute>();
    LinkedList<ObjAttribute> globalOutputsAttributes = new LinkedList<ObjAttribute>();
    LinkedList<LinkedList<ObjAttribute>> globalList = new LinkedList<LinkedList<ObjAttribute>>();
